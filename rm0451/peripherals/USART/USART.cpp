                   ...
                   Low_power_wakeup_method a_low_power_wakeup)
{
    ...
    volatile auto bbbxx = bit::flag::is(this->p_registers->cr1, ll::usart::CR1::re);
    bbbxx = bbbxx;

    wait_until::all_bits_are_set(this->p_registers->isr, ll::usart::ISR::busy);

    wait_until::all_bits_are_set(
        this->p_registers->isr,
        (true == bit::flag::is(this->p_registers->cr1, ll::usart::CR1::re) ?
             (ll::usart::ISR::reack | ll::usart::ISR::idle) :
             ll::usart::ISR::none) |
            ...
            (a_transceiving_config.mute_method == Transceiving_config::Mute_method::idle_line ||
                     true == bit::flag::is(
                                 static_cast<std::uint32_t>(a_transceiving_config.mute_method),
                                 static_cast<std::uint32_t>(Transceiving_config::Mute_method::character_matched)) ?
                 ll::usart::ISR::rwu :
                 ll::usart::ISR::none));

    if (true == bit::flag::is(this->p_registers->isr, ll::usart::ISR::idle))
    {
        bit::flag::set(&(this->p_registers->icr), ll::usart::ICR::idlecf);
    }
}
